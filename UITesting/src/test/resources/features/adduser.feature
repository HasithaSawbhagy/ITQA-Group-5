Feature: Create User in HRM System
  ...
  Scenario: Create a new user with role Admin
    ...
    And I fill in the required fields with role "Admin", status "Enabled", employee name "John  Doe", username "john_doeee", password "Johnevans123#", and confirm password "Johnevans123#"
