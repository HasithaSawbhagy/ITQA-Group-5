Feature: Create User in HRM System
  ...
  Scenario: Create a new user with role Admin
    ...
    And I fill in the required fields with role "Admin", status "Enabled", employee name "joker john selvam", username "john_sta", password "Johnevans123#", and confirm password "Johnevans123#"
